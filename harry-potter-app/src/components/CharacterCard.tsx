      ...
      <div className={`flex rounded-xl items-center ${houseColorClass}`}>
        ...
        <div className="flex flex-col items-start justify-between mx-auto py-1">
          ...
          <div className="flex flex-row my-5">
            <Link to={`/characters/${character.id}`} className="font-medium text-white hover:border-black bg-slate-800 flex card-link border-1 border px-2 py-1 rounded mx-1">
              View details
            </Link>
            <FavoriteButton
